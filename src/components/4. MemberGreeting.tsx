...
const members = [
  ...
  },
  {
    ...
    description: (
      <>
        山口県出身。東京大学医学部健康総合科学科を卒業後、国立がん研究センター中央病院にて看護師としてキャリアをスタートし、様々な専門性の高い現場で医療に従事。<br />
        その後、教育とゲームを掛け合わせた領域への関心からエストニアへ渡り、タリン大学大学院のDigital Learning Games修士課程に進学、教育支援や学習用ゲームのデザインなど、自身のバックグラウンドを活かし「ゲームを通じたコミュニケーション」を実践してきた。<br />
        現在はタリンを拠点とするオンラインゲーム企業Studioworks OÜにて勤務しつつ、JPEE+でエストニアと日本を繋ぐ活動の支援や、ゲームプロジェクト部門の立ち上げを企画中。専門性を活かしつつ、新たな可能性を追求し続けている。
      </>
    ),
    location: "エストニア - タリン",
    image: AkemiProf,
