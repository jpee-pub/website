...
const activities = [
  {
    icon: DiscordIcon,
    title: "Discord",
    description: "JPEE+同盟のメインプラットフォーム。情報交換、雑談、イベント企画など、日々活発な交流が行われています。",
    status: "活動中",
    link: "#alliance",
    color: "bg-[#7289DA]"
  },
  {
    ...
    status: "活動中",
    link: "https://note.com/jpee_plus",
    color: "bg-[#41C9B4]"
  },
  {
    icon: SpotifyIcon,
    title: "ラジオ",
    description: "JPEE+の活動やメンバー、ゲストによるトークを配信中。活動の紹介から意外な裏側まで!?幅広くお届け。",
    status: "活動中",
  ...
  },
  {
    icon: YoutubeIcon,
    title: "YouTube",
    description: "プロモ動画や活動の様子、ラジオトークの動画版を配信します。見てわかるJPEE+の魅力をどうぞ!",
    status: "準備中",
